...
\begin{frame}
  \frametitle{Free Boolean Algebra}
  \only<1>{\inputminted[highlightlines={4,5}, highlightcolor=yellow!40]{scala}{snippets/free-bool-interp.scala}}
  \only<2>{\inputminted[highlightlines={6}, highlightcolor=yellow!40]{scala}{snippets/free-bool-interp.scala}}
  \only<3>{\inputminted[highlightlines={7}, highlightcolor=yellow!40]{scala}{snippets/free-bool-interp.scala}}
  \only<4>{\inputminted[highlightlines={9,11}, highlightcolor=yellow!40]{scala}{snippets/free-bool-interp.scala}}
\end{frame}

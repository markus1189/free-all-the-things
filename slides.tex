...
\begin{frame}[fragile]
  ...
  \only<2>{\inputminted[highlightlines={3}, highlightcolor=yellow!40]{scala}{snippets/opt-free-instance.scala}}
  \only<3>{\inputminted[highlightlines={3, 6}, highlightcolor=yellow!40]{scala}{snippets/opt-free-instance.scala}}
\end{frame}
...
\begin{frame}
  ...
  \only<2>{\inputminted[highlightlines={5, 7}, highlightcolor=yellow!40]{scala}{snippets/opt-free-ap-instance.scala}}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \only<2>{\inputminted[highlightlines={6-7}, highlightcolor=yellow!40]{scala}{snippets/free-functor1.scala}}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \only<2>{\inputminted[highlightlines={6-8}, highlightcolor=yellow!40]{scala}{snippets/functor-coyoneda.scala}}
\end{frame}
...
\begin{frame}
  ...
  \only<2>{\inputminted[highlightlines={4}, highlightcolor=yellow!40]{scala}{snippets/eval-search-predicate.scala}}
  \only<3>{\inputminted[highlightlines={5}, highlightcolor=yellow!40]{scala}{snippets/eval-search-predicate.scala}}
  \only<4>{\inputminted[highlightlines={6}, highlightcolor=yellow!40]{scala}{snippets/eval-search-predicate.scala}}
  \only<5>{\inputminted[highlightlines={7}, highlightcolor=yellow!40]{scala}{snippets/eval-search-predicate.scala}}
\end{frame}
